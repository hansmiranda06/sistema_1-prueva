<?php
// 1. ACTIVACIÓN DE ALERTAS DE DIAGNÓSTICO (Evita pantallas en blanco/negro si falla la BD)
ini_set('display_errors', 1);
ini_set('display_startup_errors', 1);
error_reporting(E_ALL);

// 2. CONFIGURACIÓN Y CONEXIÓN A BASE DE DATOS
...
// 4. EXTRACCIÓN DE TELEMETRÍA (DATOS REALES)
