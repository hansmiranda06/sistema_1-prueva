<?php
// 1. FORZAR REPORTE DE ERRORES VISIBLES
ini_set('display_errors', 1);
ini_set('display_startup_errors', 1);
error_reporting(E_ALL);

// Desactivar el lanzamiento automático de excepciones en mysqli para evitar bloqueos
...
// Intentar conectar con un tiempo de espera corto (timeout de 2 segundos)
$conexion = mysqli_init();
if ($conexion) {
    mysqli_options($conexion, MYSQLI_OPT_CONNECT_TIMEOUT, 2);
...
$mensaje_feedback = "";
$status_db_msg = "<span style='color: #0ecb81;'>● CONEXIÓN EN VIVO (BD OK)</span>";

if (!$conexion) {
    $status_db_msg = "<span style='color: #f6465d;'>⚠️ MODO SIMULACIÓN (BD NO DISPONIBLE AÚN)</span>";
}

// 3. PROCESAMIENTO DE ACCIONES EN CAMPO (POST)
...
// 4. VALORES POR DEFECTO / SEMILLA (Garantizan que la pantalla cargue SIEMPRE)
...
// Si la conexión está activa, sobreescribimos los valores semilla con los datos de la BD
if ($conexion) {
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .tank-bar { height: 24px; background: #2b3139; border-radius: 12px; overflow: hidden; border: 1px solid #475260; margin: 10px 0; }
